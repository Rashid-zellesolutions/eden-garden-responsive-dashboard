...
function FoodOptions({ label, value, onChange, PersonQtyLabel, personQtValue, onChangePersonQty, unitPrice, setUnitPrice, Total, selectOption,
    onClick, selectDisabled, descriptionValue, descriptionDisabled, qtyDisabled, priceDisabled, setInvoice, Invoice,onChangeDescription }) {
    return (
        <div style={{
            width: "100%",
            marginBottom: 15,

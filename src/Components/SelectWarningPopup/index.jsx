...
function SelectWarningPopup({ isModalOpen, handleCancel }) {
    return (
        <Modal width={"25%"} title={""} open={isModalOpen} className="custom-modal-color" onCancel={handleCancel} footer={[<></>]} style={{ padding: "20px", top: "38%" }} >
            <div className="warning-container">
                ...
                <h3 className="warning-heading">Please Select Date and Time Slot both for Event.</h3>
            </div>
        </Modal>
    )
}
export default SelectWarningPopup
...
const UpdateAppetizer = () => {
    ...
    const handleInputsChange = (e) => {
        ...
        setAppetizerData(prevData => ({
            ...prevData,
            [name]: value
        }));
        console.log("Appetizer Data after input change:", appetizerData);
    }
    ...
    const handleImageChange = (e) => {
        setAppetizerData({...appetizerData, appetizerImage: e.target.files[0]});
    }
    
    // console.log(appetizerData.appetizerImage);
    
    const handleAppetizerUpdate = async(e) => {
        e.preventDefault();
        // console.log(appetizerData.appetizerImage)
        const formData = new FormData();
        formData.append('name', appetizerData.name);
        formData.append('cost', appetizerData.cost);
        formData.append('pacFor', appetizerData.pacFor);
        formData.append('appetizerImage', appetizerData.appetizerImage);
        ...
        try {
            const response = await axios.put(`http://localhost:8080/api/v1/Appetizers/update-appetizer/${id}`, formData, {
                headers: {
  ...
  return (
    <div style={{width: '100%'}}>
        ...
        <div style={{width: '100%', padding: '10px 25px'}}>
            <form onSubmit={handleAppetizerUpdate} style={{width: '100%'}}>
                <div style={{
...
export default UpdateAppetizer

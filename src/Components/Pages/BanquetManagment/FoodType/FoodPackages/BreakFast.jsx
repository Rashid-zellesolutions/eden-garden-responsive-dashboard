...
// Function to sum costs in an array of items
    ...
    return (
        ...
        <div style={{width: '100%', padding: '0px 10px'}}>
            <Table sticky columns={columns} dataSource={data} locale={customLocale} pagination={shouldShowPagination ? { pageSize: 2 } : false} />
        </div>
            <div style={{width: '100%', display: 'flex', padding: '0px 10px', justifyContent: 'start', marginTop: '10px', marginBottom: '10px'}}>
                {packageVisible ? <h3>Add Breakfast</h3> : <Button type="primary" htmlType="submit"
                style={{

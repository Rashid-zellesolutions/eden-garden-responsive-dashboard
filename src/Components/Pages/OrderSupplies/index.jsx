...
function OrderSupplies() {
    ...
    const handleRowClick = (record, event) => {
        ...
        navigate(`/Order/Order-Supplies-Data/${record._id}`, { state: record });
    ...
    return (
        <div style={{ padding: "20px" }}>
            {loading ? <Loader /> : <>
                <Table style={{ width: "100%" }} columns={columns} dataSource={filteredData} pagination={{ style: { color: "#b78953" } }}
                    onRow={(record) => ({

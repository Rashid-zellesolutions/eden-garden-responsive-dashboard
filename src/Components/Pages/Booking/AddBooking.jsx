            ...
            <div className='input-wrapper'>
                ...
                {proceedState && <>
                    ...
                    <div style={{width: "100%", display: "flex", flexDirection: 'column', alignItems: "center", flexWrap: "wrap",}}>
                        ...
                        <InputField placeholder={"First Name*"} label={"First Name*"} width={"33.5%"} value={firstName} onChange={(e) => setFirstName(e.target.value)} />
                        <InputField placeholder={"last Name*"} label={"Last Name*"} width={"33.5%"} value={lastName} onChange={(e) => setLastName(e.target.value)} />
                        <InputField placeholder={"Email*"} label={"Email*"} width={"33%"} value={email} onChange={(e) => setEmail(e.target.value)} />
                        ...
                        <InputField placeholder={"Zip*"} label={"Zip*"} width={"15%"} value={zip} onChange={(e) => setZip(e.target.value)} />
                        <InputField placeholder={"City*"} label={"City*"} width={"25%"} value={city} onChange={(e) => setCity(e.target.value)} />
                        <InputField placeholder={"State*"} label={"State*"} width={"25%"} value={state} onChange={(e) => setState(e.target.value)} />
                        </div>
                    </div>
                    </fieldset>
